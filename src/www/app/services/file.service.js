   ...
   angular
    ...
    return {
      ...
      query: function(params){
        return $http({
          url: appConstants.apiRoot + '/v2/file',
          params: params,
          method: 'GET'
      ...
      sign: function(params) {
        return $http({
          method: 'POST',
          url: appConstants.apiRoot + '/v2/file/sign',
          data: params
        }).then(function(result){
          return result.data;
        });
      ...
      finishUpload: function(data) {
        return $http({
          method: 'POST',
          url: appConstants.apiRoot + '/v2/file/finish-upload',
          data: data
        }).then(function (result) {
          return result.data;
        });
      ...
      destroy: function(id) {
        return $http({
          url: appConstants.apiRoot + '/v2/file/' + id,
          method: 'DELETE',
        }).then(function(result){
          return result.data;
        });
